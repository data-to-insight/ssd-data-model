...
/* [D2I TESTING ONLY]
=============================================================================
Object Name: #ssd_person_is_client [D2I TESTING ONLY]
Uses only is_client filter nothing else
=============================================================================
*/
-- [TESTING] Create marker
SET @TableName = N'ssd_person_is_client';
PRINT 'Creating table: ' + @TableName;


-- check exists & drop
IF OBJECT_ID('#ssd_person_is_client') IS NOT NULL DROP TABLE #ssd_person_is_client;
IF OBJECT_ID('tempdb..#ssd_person_is_client') IS NOT NULL DROP TABLE #ssd_person_is_client;


-- Create structure
CREATE TABLE #ssd_person_is_client (
    pers_legacy_id          NVARCHAR(48),               -- metadata={"item_ref":"PERS014A"}               
    pers_person_id          NVARCHAR(48) PRIMARY KEY,   -- metadata={"item_ref":"PERS001A"}   
    pers_sex                NVARCHAR(20),               -- metadata={"item_ref":"PERS002A"} 
    pers_gender             NVARCHAR(10),               -- metadata={"item_ref":"PERS003A", "item_status":"T", "expected_data":["unknown","NULL", "F", "U", "M", "I"]}       
...
-- Insert data
INSERT INTO #ssd_person_is_client (
    pers_legacy_id,
    pers_person_id,
    pers_sex,
    pers_gender,
...
CREATE TABLE #ssd_constraint_log (
