...
(
	...
	from moLive.dbo.WORKERS a
	inner join moLive.dbo.WORKER_ROLES wr on a.ID = wr.WORKER_ID
	inner join moLive.dbo.WORKER_ROLE_TYPES wrt on wr.ROLE = wrt.ROLE
	inner join moLive.dbo.ORGANISATIONS org on wr.ORG_ID = org.ID
	--left join Returns.CSCWC.HCPC b on a.ID = b.WID /*Table only in Data Warehoouse*/
	...
	(
		...
		(
			...
			from moLive.dbo.ORGANISATIONS o1
			left join moLive.dbo.ORGANISATION_STRUCTURE os1 on o1.id = os1.CHILD_ORG_ID
			left join moLive.dbo.ORGANISATIONS o2 on os1.PARENT_ORG_ID = o2.id
			left join moLive.dbo.ORGANISATION_STRUCTURE os2 on o2.id = os2.CHILD_ORG_ID
			left join moLive.dbo.ORGANISATIONS o3 on os2.PARENT_ORG_ID = o3.id
			left join moLive.dbo.ORGANISATION_STRUCTURE os3 on o3.id = os3.CHILD_ORG_ID
			left join moLive.dbo.ORGANISATIONS o4 on os3.PARENT_ORG_ID = o4.id
			left join moLive.dbo.ORGANISATION_STRUCTURE os4 on o4.id = os4.CHILD_ORG_ID
			left join moLive.dbo.ORGANISATIONS o5 on os4.PARENT_ORG_ID = o5.id
			left join moLive.dbo.ORGANISATION_STRUCTURE os5 on o5.id = os5.CHILD_ORG_ID
			left join moLive.dbo.ORGANISATIONS o6 on os5.PARENT_ORG_ID = o6.id
			left join moLive.dbo.ORGANISATION_STRUCTURE os6 on o6.id = os6.CHILD_ORG_ID
			left join moLive.dbo.ORGANISATIONS o7 on os6.PARENT_ORG_ID = o7.id
...
(
	...
	from moLive.dbo.PEOPLE_WORKERS pw
