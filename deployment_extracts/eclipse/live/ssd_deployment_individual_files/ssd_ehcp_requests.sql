...
-- =============================================================================
-- DROP TABLE IF EXISTS ssd_ehcp_requests;

-- META-ELEMENT: {"type": "create_table"}
CREATE TABLE IF NOT EXISTS ssd_ehcp_requests (
    ehcr_ehcp_request_id       VARCHAR(48) PRIMARY KEY,  -- metadata={"item_ref":"EHCR001A"}
    ehcr_send_table_id         VARCHAR(48),              -- metadata={"item_ref":"EHCR002A"}
    ehcr_ehcp_req_date         TIMESTAMP,                -- metadata={"item_ref":"EHCR003A"}
    ehcr_ehcp_req_outcome_date TIMESTAMP,                -- metadata={"item_ref":"EHCR004A"}
    ehcr_ehcp_req_outcome      VARCHAR(100)              -- metadata={"item_ref":"EHCR005A"}
);

TRUNCATE TABLE ssd_ehcp_requests;

INSERT INTO ssd_ehcp_requests (
    ehcr_ehcp_request_id,
    ehcr_send_table_id,
    ehcr_ehcp_req_date,
    ehcr_ehcp_req_outcome_date,
    ehcr_ehcp_req_outcome
)
SELECT
    ...
    NULL AS "ehcr_ehcp_request_id",       --metadata={"item_ref":"EHCR001A"}
    /* currently PLACEHOLDER_DATA pending further development 
       ID for linking to ssd_send table */
    NULL AS "ehcr_send_table_id",         --metadata={"item_ref":"EHCR002A"}
    /* currently PLACEHOLDER_DATA pending further development 
       The date the request for an EHC assessment was received. This will be the date used as the start of the 20 week period. */
    NULL AS "ehcr_ehcp_req_date",         --metadata={"item_ref":"EHCR003A"}
    /* currently PLACEHOLDER_DATA pending further development 
    ...
    NULL AS "ehcr_ehcp_req_outcome_date", --metadata={"item_ref":"EHCR004A"}
    /* currently PLACEHOLDER_DATA pending further development 
    ...
    NULL AS "ehcr_ehcp_req_outcome";      --metadata={"item_ref":"EHCR005A"}
