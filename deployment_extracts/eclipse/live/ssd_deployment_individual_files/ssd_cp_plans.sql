...
-- =============================================================================
-- DROP TABLE IF EXISTS ssd_cp_plans;

-- META-ELEMENT: {"type": "create_table"}
CREATE TABLE IF NOT EXISTS ssd_cp_plans (
    cppl_cp_plan_id               VARCHAR(48) PRIMARY KEY, -- metadata={"item_ref":"CPPL001A"}
    cppl_referral_id              VARCHAR(48),             -- metadata={"item_ref":"CPPL007A"}
    cppl_icpc_id                  VARCHAR(48),             -- metadata={"item_ref":"CPPL008A"}
    cppl_person_id                VARCHAR(48),             -- metadata={"item_ref":"CPPL002A"}
    cppl_cp_plan_start_date       TIMESTAMP,               -- metadata={"item_ref":"CPPL003A"}
    cppl_cp_plan_end_date         TIMESTAMP,               -- metadata={"item_ref":"CPPL004A"}
    cppl_cp_plan_ola              CHAR(1),                 -- metadata={"item_ref":"CPPL011A"}       
    cppl_cp_plan_initial_category VARCHAR(100),            -- metadata={"item_ref":"CPPL009A"}
    cppl_cp_plan_latest_category  VARCHAR(100)             -- metadata={"item_ref":"CPPL010A"}
);
