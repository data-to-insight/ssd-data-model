...
IF OBJECT_ID('[eclipseDelta].[dbo].[ssd_initial_cp_conference]', 'U') IS NOT NULL
BEGIN
    IF EXISTS (
        SELECT 1
        FROM [eclipseDelta].[dbo].[ssd_initial_cp_conference]
    )
        TRUNCATE TABLE [eclipseDelta].[dbo].[ssd_initial_cp_conference];
END
ELSE
BEGIN
    CREATE TABLE [eclipseDelta].[dbo].[ssd_initial_cp_conference] (
...
INSERT INTO [eclipseDelta].[dbo].[ssd_initial_cp_conference] (
    icpc_icpc_id,
