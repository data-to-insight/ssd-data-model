...
-- -- Opt 0: concat values using FOR XML PATH
-- SELECT 
--     FACT_FORM_ID,
--     '[' + STUFF((
--         SELECT ',"' + ANSWER_NO + '"' 
...
-- -- Opt 0: join and insert into final ssd_assessment_factors with batching
...
INSERT INTO ssd_api_data_staging (json_payload)
SELECT 
(
    SELECT 
