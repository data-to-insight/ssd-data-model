    ...
    SELECT 
        ...
        JSON_QUERY((
            ...
            SELECT 
                ...
                ISNULL(d.DIM_LOOKUP_INVOLVEMENT_TYPE_DESC, '')    AS INVOLVEMENT_TYPE_DESC, -- added as use of type_code from within the json for type_desc lookup is problematic on older ver of sql server
            ...
            FOR JSON PATH   --, WITHOUT_ARRAY_WRAPPER
                            -- incl WITHOUT_ARRAY_WRAPPER IF restricting FULL contact history to a single entry in _json (involvement_history_json)
